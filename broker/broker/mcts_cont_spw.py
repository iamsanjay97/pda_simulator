...
class MCTS_Cont_SPW(gym.Env):
    ...
    def set(self, total_demand, number_of_bids=1, buy_limit_price_min=-90.0, buy_limit_price_max=-1.0, sell_limit_price_min=0.5, sell_limit_price_max=90.0, id='MCTS'):
        self.id = id
